...
const ToolBar = () => {
  return (
    <div className="flex w-[1440px] h-[50px] md: items-center gap-6 border-b px-8 py-2 border-gray-200 pb-1 text-sm font-medium text-black shadow-sm justify-between ">
      ...
      {/* right part of this nav bar  */}

      <div className="flex flex-col gap-4 text-sm font-medium text-black ">
        {/* Action Buttons */}
        <div className="flex items-center gap-3">
          <button className="flex items-center gap-2 rounded-md border border-gray-300 px-4 py-2 text-gray-700 bg-white hover:bg-gray-100  cursor-pointer">
          ...
          <button className="flex items-center gap-2 rounded-md bg-green-700 px-4 py-2 text-white hover:bg-green-800  cursor-pointer">
            <RepeatIcon className="w-4 h-4" />
